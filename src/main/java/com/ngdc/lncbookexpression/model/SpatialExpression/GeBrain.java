...
public class GeBrain {
    ...
    private float eighteen_week;
    private float nineteen_week;
    private float twenty_week;
    ...
    public float getEighteen_week() { return eighteen_week; }
    public void setEighteen_week(float eighteen_week) { this.eighteen_week = eighteen_week; }

    public float getNineteen_week() { return nineteen_week; }
    public void setNineteen_week(float nineteen_week) { this.nineteen_week = nineteen_week; }

    public float getTwenty_week() { return twenty_week; }
    public void setTwenty_week(float twenty_week) { this.twenty_week = twenty_week; }

...
public class GeLiver {
    ...
    private float middle_adult;
    private float elderly;
    ...
    public float getNineteen_week() {
        return nineteen_week;
    }

    public void setNineteen_week(float nineteen_week) {
        this.nineteen_week = nineteen_week;
    }

    public float getNeonate() {
        return neonate;
    }

    public void setNeonate(float neonate) {
        this.neonate = neonate;
    }

    public float getInfant() {
        return infant;
    }

    public void setInfant(float infant) {
        this.infant = infant;
    }

    public float getToddler() {
        return toddler;
    }

    public void setToddler(float toddler) {
        this.toddler = toddler;
    }

    public float getSchool_age_child() {
        return school_age_child;
    }

    public void setSchool_age_child(float school_age_child) {
        this.school_age_child = school_age_child;
    }

    public float getAdolescent() {
        return adolescent;
    }

    public void setAdolescent(float adolescent) {
        this.adolescent = adolescent;
    }

    public float getYoung_adult() {
        return young_adult;
    }

    public void setYoung_adult(float young_adult) {
        this.young_adult = young_adult;
    }

    public float getMiddle_adult() {
        return middle_adult;
    }

    public void setMiddle_adult(float middle_adult) {
        this.middle_adult = middle_adult;
    }
    ...
    public void setElderly(float elderly) {

...
$(function () {
    ...
    function succFunction(data) {
        ...
        $(function () {
            var boxSize = $('#exosome2_plot').width();
            var data = [];
            var cancers = ["GeneID","Normal","ESCC"]
            for ( var i = 1; i < cancers.length; i ++ ) {
                var result = {
                    type: 'box',
                    y: ex_value[i-1],
            ...
            layout = {
                title: 'Exosomes from Normal and ESCC Group <br>(' + geneid + ")",
                font: {
            ...
            Plotly.newPlot('exosome2_plot', data, layout);

            window.addEventListener("resize",function() {
                var newBoxWidth = $('#exosome2_plot').width();
                var newBoxLayout = {
                    title: 'Exosomes from Normal and ESCC Group <br>(' + geneid + ")",
                    yaxis: {
                        autorange: true,
                ...
                Plotly.newPlot('exosome2_plot', data, newBoxLayout);
            });

...
var url1 = "/LncExpDB/pattern/preimplantation1";
hkts_table(url1)

$('#tissuename').select2({
    ajax: {
        url: "/LncExpDB/pattern/preimplantation1/tissuename",
        dataType: 'json'
    }
});
...
$("#type").on("change",function () {
    ...
    if (type == "preimplantation1") {
        ...
        $('input[name="maxBreadth"]').val(7);
        $('input[name="maxBreadth"]').attr("max", '7');
        $('input[name="maxBreadth"]').attr("min", '0');
        $('input[name="minBreadth"]').attr("max", '7');
        $('input[name="minBreadth"]').attr("min", '0');
        $('input[name="cv2"]').val(2.65);
        $('input[name="cv1"]').val(0);
        $('input[name="cv1"]').attr("max", '2.65');
        $('input[name="cv1"]').attr("min", '0');
        $('input[name="cv2"]').attr("max", '2.65');
        $('input[name="cv2"]').attr("min", '0');
    } else if (type == "preimplantation2") {
        $('input[name="minBreadth"]').val(0);
        $('input[name="maxBreadth"]').val(9);
        $('input[name="maxBreadth"]').attr("max", '9');
        $('input[name="maxBreadth"]').attr("min", '0');
        $('input[name="minBreadth"]').attr("max", '9');
        $('input[name="minBreadth"]').attr("min", '0');
        $('input[name="cv2"]').val(3);
        $('input[name="cv1"]').val(0);
        $('input[name="cv1"]').attr("max", '3');
        $('input[name="cv1"]').attr("min", '0');
        $('input[name="cv2"]').attr("max", '3');
        $('input[name="cv2"]').attr("min", '0');
    }
})
...
$("#reset").on('click', function () {
    ...
    $('input[name="minBreadth"]').val(0);
    $('input[name="maxBreadth"]').val(9);
    var url = "/LncExpDB/pattern/preimplantation1";
    hkts_table(url);
    var url_tissue = "/LncExpDB/pattern/preimplantation1/tissuename";
    $('#tissuename').select2({
        ajax: {
            url: url_tissue,
            dataType: 'json'
...
var url1 = "/LncExpDB/ce/preimplantation1";
ce_table(url1)
...
$('#ce_tsr').click(function () {
    var type = $('#ce_type').val();
    $('#ce_tissuename').empty();
    $("#ce_table").bootstrapTable('refreshOptions', {url:'/LncExpDB/ce/subcellular' + type + 'distance?start=0',  silent: true, pageNumber: 1, pageSize: 10});
});
...
$("#ce_reset").on('click', function () {
    ...
    $("#featurelnc").empty();
    $('#featurelnc_cancel').hide();
    var url = "/LncExpDB/ce/preimplantation1";
    ce_table(url);
});

// Select2
var url1 = "/LncExpDB/ce/preimplantation1lncid";
...
// Featured Select2
var url1 = "/LncExpDB/pattern/preimplantation1/geneidlist";
